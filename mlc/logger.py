...
class ColoredFormatter(logging.Formatter):
    ...
    def format(self, record):
        ...
        # Left-align filename with 15 char width
        record.filename = f"{record.filename:<15}"
        # Right-align line number with 4 char width
        ...
        # Left-align levelname with 5 char width
        levelname_padded = f"{levelname:<5}"
