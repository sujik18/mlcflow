...
class Action:
    ...
    def cp(self, run_args):
        ...
        if action_target != "script":
            return {"return": 1, "error": f"The {action_target} is not currently supported for mv/cp"}
        inp = {}
    ...
    def mv(self, run_args):
        ...
        if target_name != "script":
            return {"return": 1, "error": f"The {target_name} is not currently supported for mv/cp"}
